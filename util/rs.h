 ...
 * alive. If not, then reads are queried from the non-preferred nodes, or 
 * the Master itself.
 */
int mongo_util_rs_set_node_preferred(mongo_link *link, char **prefNodes, int nodesCount, char **errmsg TSRMLS_DC);
